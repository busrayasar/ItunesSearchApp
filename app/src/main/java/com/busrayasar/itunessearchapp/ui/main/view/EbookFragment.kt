...
class EbookFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        Log.d("Ebook", "Ebook fragment is choosen")
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mainViewModel.fetchPosts(temp, limit, "feature_ebook")
    }
        ...
        binding.searchBarView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            override fun onQueryTextSubmit(query: String?): Boolean {
                query?.let {
                    ...
                    mainViewModel.fetchPosts(query, limit,"feature_ebook")
                    temp = query
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                newText?.let {
                    ...
                    mainViewModel.fetchPosts(newText,limit,"feature_ebook")
                    temp = newText
                }
                return false
            }
    ...
    private fun setUpUI() {
        binding.ebookItemRecyclerView.layoutManager = LinearLayoutManager(requireContext())
        recyclerViewAdapter = ItunesAdapter(arrayListOf())
        binding.ebookItemRecyclerView.adapter = recyclerViewAdapter
    }
        ...
        mainViewModel.data.observe(viewLifecycleOwner, Observer {
            when (it.status) {
                Status.SUCCESS -> {
                    ...
                    binding.ebookItemRecyclerView.visibility = View.VISIBLE
                }
                Status.LOADING -> {
                    Log.d("STATUS/LOADING", it.toString())
                    binding.progressBar.visibility = View.VISIBLE
                    binding.ebookItemRecyclerView.visibility = View.GONE
                }
