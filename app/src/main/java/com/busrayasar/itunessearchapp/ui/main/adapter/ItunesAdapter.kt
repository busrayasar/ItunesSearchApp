...
import com.busrayasar.itunessearchapp.ui.main.view.MoviesFragmentDirections
...
class ItunesAdapter(private val data: ArrayList<Result>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DataViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_design_layout, parent, false)
    ...
    override fun onBindViewHolder(holder: DataViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            Log.e("adapter", resultData.collectionName + " " + resultData.wrapperType)

            //item tıklanınca detay sayfasına buradan gidecek

            val action = MainFragmentDirections.actionMainFragmentToDetailPageFragment5()
